now for the next part is the TripTypes could you please make sure those work right like the rest of the pages we have done so far? create a plan for them
TripTypes
...
Response headers
 ...
 date: Tue,04 Aug 2026 09:20:04 GMT 
...
Response headers
 ...
 content-type: application/json; charset=utf-8 
 date: Tue,04 Aug 2026 09:20:27 GMT 
 server: Microsoft-IIS/10.0 
 x-powered-by: ASP.NET 
Responses
Code	Description	Links
...
Response headers
 access-control-allow-origin: * 
 content-type: application/json; charset=utf-8 
 date: Tue,04 Aug 2026 09:20:51 GMT 
 server: Microsoft-IIS/10.0 
 x-powered-by: ASP.NET 
Responses
Code	Description	Links
...
curl -X 'GET' \
  'https://travelapi.runasp.net/api/TripTypes/9' \
  -H 'accept: text/plain' \
  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..uMb81UtfdtYcfM6q1vJ8pRCp8uUitz9z4en38ZsN8Rs'
Request URL
https://travelapi.runasp.net/api/TripTypes/9
...
{
  "success": true,
  "message": "Trip Type Data For Id 9",
  "data": {
    "id": 9,
    "name": "string4"
  }
...
Response headers
 content-type: application/json; charset=utf-8 
 date: Tue,04 Aug 2026 09:21:00 GMT 
 server: Microsoft-IIS/10.0 
 x-powered-by: ASP.NET 
Responses
Code	Description	Links
...
{
  "Success": false,
  "Message": "Cannot delete trip type because it is associated with existing trips.",
  "Data": null
}
Response headers
 access-control-allow-origin: * 
 content-type: application/json 
 date: Tue,04 Aug 2026 09:21:15 GMT 
 server: Microsoft-IIS/10.0 
 x-powered-by: ASP.NET 
Responses
Code	Description	Links
